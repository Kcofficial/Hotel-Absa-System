...
```bash
# Clone repository
git clone https://github.com/Kcofficial/Hotel-Absa-System.git
cd Hotel-Absa-System
...
- **Production URL**: https://hotel-absa-system.vercel.app
...
```bash
# Build image
docker build -t hotel-absa-system .

# Run container
docker run -p 3000:3000 hotel-absa-system
```
...
- Email: dedi.kundana@its.ac.id
- GitHub Issues: https://github.com/Kcofficial/Hotel-Absa-System/issues
- Live Demo: https://hotel-absa-system.vercel.app
